...
const Cart = () => {
    ...
    const updatedCart = carts
      .map((item) => {
        if (item.id === id) {
          ...
          if (newQuantity === 0) {
            removeProduct(id);
            console.log("I am pressed help me", id);
            return null;
          } else {
            return {
              ...item,
  ...
  const [discountedTotal, setDiscountedTotal] = useState(total); // final total with promo code discount applied
        ...
        <div className="container mx-auto mt-10">
          <div className="flex shadow-md my-10">
            ...
            <div id="summary" className="w-1/4 px-8 py-10">
              ...
              {promoCode && promoCode !== 'Smith' && <p className="mt-2 uppercase  font-bold text-red-500">PromoCode not valid!</p>}
